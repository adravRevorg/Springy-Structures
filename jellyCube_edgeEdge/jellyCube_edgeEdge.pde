...
//Triangle's vertices
PVector[][] pT = new PVector[2][3];
PVector[] nT = new PVector[2];
PVector[] AT = new PVector[2];   //area vector


//Environmental Parameters
float e = 1;    //elasticity
float cf = 0;//0.2;   //coefficient of friction
float ar = 0;//2 ;     //air resistance
float d = 0;//2;       //air resistance  (new)
PVector vwind = new PVector(0,0,0);   //wind

boolean edgeCollision = false;
boolean vertexCollision = false;

boolean[] atRest = new boolean[8];
